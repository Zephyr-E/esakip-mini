        ...
        <div class="modal-content">
            <div class="card">
                ...
                <div class="modal-body">
                    ...
                    <form id="form-edit-kegiatan-{{ $kegiatan_indikator->id }}" class="form-material"
                        ...
                        <div class="form-group form-primary form-static-label pb-4">
                            <input type="number" name="target" class="form-control"
                                value="{{ $kegiatan_indikator->target }}" required>
                            <span class="form-bar"></span>
                            <label class="float-label">Masukkan Target</label>
                        </div>
                        <div class="form-group form-primary form-static-label pb-4">
                            <input name="realisasi" class="form-control" value="{{ $kegiatan_indikator->realisasi }}"
                                required>
                            <span class="form-bar"></span>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" form="form-edit-kegiatan-{{ $kegiatan_indikator->id }}"
